...
const FORECAST_CLIENT_CACHE_VERSION = "v3";
...
function renderValidation(data) {
  ...
  setText(
    "validationCompared",
    `${Number(summary.comparedHours || 0)} yön kararı · ${Number(summary.wrongHours || 0)} sapma`,
  );
...
function renderForecast(data) {
  ...
  setText("lowConfidenceHours", lowHours.length ? lowHours.join(" · ") : "Düşük güvenli saat yok");
