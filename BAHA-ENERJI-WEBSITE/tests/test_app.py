...
class SuiteHelpersTests(unittest.TestCase):
    ...
    def test_system_direction_abstains_below_confidence_or_margin_threshold(self):
        ...
        self.assertEqual(low_confidence["category"], "uncertain")
        self.assertTrue(low_confidence["abstained"])
        self.assertEqual(narrow_margin["category"], "uncertain")
    ...
    def test_market_today_incomplete_smf_uses_short_refresh_policy(self):
        ...
        self.assertEqual(dashboard["summary"]["ptfSmfCommonHours"], 1)
        self.assertEqual(dashboard["summary"]["smfAverage"], 1_100)
...
class SuiteHttpTests(unittest.TestCase):
    ...
    def test_login_is_a_clean_shared_portal_page(self):
        ...
        self.assertEqual(status, 200)
        self.assertIn("baha-enerji-shell-v18", worker)
        self.assertIn("NAVIGATION_TIMEOUT_MS", worker)
        self.assertIn("PRE_LOGIN_LOADING_PATHS", worker)
        self.assertIn('new Set(["/", "/login", "/login/"])', worker)
        ...
        status, content, _ = self.get("/panel-hazirlaniyor")
        loading_html = content.decode("utf-8")
        self.assertEqual(status, 200)
        self.assertIn("Sunucu uyandırılıyor", loading_html)
        self.assertIn('src="/panel-loading.js?v=3"', loading_html)
    ...
    def test_piyasa_page_paths_are_mounted_under_piyasa(self):
        ...
        self.assertIn('src="/piyasa/app.js?v=58"', html)
        ...
        self.assertIn('href="/piyasa-suite.css?v=33"', html)
    ...
    def test_piyasa_never_shows_its_old_login_screen(self):
        ...
        self.assertIn("baha-market-v5:", script)
    ...
    def test_baraj_inline_api_paths_are_mounted_under_baraj(self):
        ...
        self.assertIn("Yakından izlenecek havzalar", html)
    ...
    def test_consumption_page_and_assets_are_mounted_under_tuketim(self):
        ...
        self.assertIn('src="/tuketim/consumption.js?v=13"', html)
    ...
    def test_system_direction_forecast_page_is_mounted(self):
        ...
        self.assertIn('src="/module-suite.js?v=12"', html)
        self.assertIn('src="/system-direction-forecast.js?v=20"', html)
    ...
    def test_uretim_page_uses_equalized_logo_size(self):
        ...
        self.assertIn('src="/module-suite.js?v=12"', html)
        self.assertIn('src="/theme-sync.js?v=2"', html)
        self.assertIn('src="/uretim/app.js?v=12"', html)
