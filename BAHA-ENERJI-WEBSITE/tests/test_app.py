...
class SuiteHttpTests(unittest.TestCase):
    ...
    def test_piyasa_page_paths_are_mounted_under_piyasa(self):
        ...
        self.assertIn('src="/piyasa/app.js?v=31"', html)
        self.assertIn(
        ...
        self.assertIn('href="/piyasa-suite.css?v=20"', html)
    ...
    def test_baraj_inline_api_paths_are_mounted_under_baraj(self):
        ...
        self.assertIn('href="/module-suite.css?v=12"', html)
        self.assertIn('src="/module-suite.js?v=2"', html)
        self.assertIn('src="/theme-sync.js?v=2"', html)
        ...
        self.assertIn('href="/portal-shell.css?v=3"', html)
    ...
    def test_consumption_page_and_assets_are_mounted_under_tuketim(self):
        ...
        self.assertIn('href="/tuketim/consumption.css?v=1"', html)
        self.assertIn('src="/tuketim/consumption.js?v=1"', html)
    ...
    def test_uretim_page_uses_equalized_logo_size(self):
        ...
        self.assertIn('src="/module-suite.js?v=2"', html)
        self.assertIn('src="/theme-sync.js?v=2"', html)
        self.assertIn('src="/uretim/app.js?v=2"', html)
