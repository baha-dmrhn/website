...
class DashboardTests(unittest.TestCase):
    ...
    def test_last_complete_month_range_uses_full_previous_calendar_month(self):
        period = main.last_complete_month_range(date(2026, 8, 4))
    ...
    def test_epias_protection_snapshot_exposes_limits(self):
        ...
        self.assertEqual(
            snapshot["configured"]["jsonCache"]["ttlSeconds"],
            {
                "current": 900,
                "live": 300,
                "recent": 21600,
