...
function clearDashboard(message = "Üretim verileri alınamadı.") {
  ...
  elements.dailyReportButton.disabled = true;
  elements.monthlyReportButton.disabled = true;
  elements.dailyReportPeriod.textContent = "Veri alınamadı";
  elements.monthlyReportPeriod.textContent = "Veri alınamadı";
}
...
function render(data, requestedPeriod = null) {
  ...
  elements.status.className = incomplete ? "connection warning" : "connection live";
  elements.status.querySelector("span").textContent = incomplete ? "EPİAŞ eksik veri" : "EPİAŞ canlı";
